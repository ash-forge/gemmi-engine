...
public class Step13AvatarStudioTest
{
    public static void Main()
    {
        ...
        string outputGlbPath = @"C:\Users\admin\haven-server\wwwroot\uploads\gemmi_sovereign_avatar_v2.glb";
        ...
        {
            CompanionName = "Ash Sovereign Gemmi Companion",
            HeightMeters = 1.75f,
            PrimaryColor = (0.0f, 0.95f, 0.99f, 1.0f),  // Cyan Base
            AccentColor = (0.95f, 0.33f, 0.85f, 1.0f),  // Magenta Accents
